...
PAR_SRC = $(SRC_DIR)/parallel_shortest_paths.cu $(SRC_DIR)/graph.cpp
PAR_OBJ = parallel_shortest_paths.o graph.o
SEQ_SRC = $(SRC_DIR)/seq_shortest_path.cpp $(SRC_DIR)/graph.cpp
SEQ_OBJ = seq_shortest_path.o graph.o
...
parallel_shortest_paths.o: $(SRC_DIR)/parallel_shortest_paths.cu $(SRC_DIR)/graph.h
	$(NVCC) -c $(NVCCFLAGS) -o parallel_shortest_paths.o $(SRC_DIR)/parallel_shortest_paths.cu

seq_shortest_path.o: $(SRC_DIR)/seq_shortest_path.cpp $(SRC_DIR)/graph.h
